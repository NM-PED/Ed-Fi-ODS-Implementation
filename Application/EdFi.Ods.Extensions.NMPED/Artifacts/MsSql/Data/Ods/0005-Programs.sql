...
DECLARE 
	...
	,@EdOrgId		INT
	,@StringVal_1A	NVARCHAR(100)	=	'BEP - Participation Code 1'	-- ProgramName
	,@CodeValue_1	NVARCHAR(50)	=	'BEP'							-- ProgramTypeDescriptorId (CodeValue for lookup)
	,@StringVal_1B	NVARCHAR(50)	=	'BEP-1'							-- ProgramId
	...
	-- SY25 Change - Change to NMPREK 
	/* OLD CODES SO I DON'T FORGET
	...
	*/
	,@StringVal29A	NVARCHAR(100)	=	'NMPREK 3 Year Old Full-Day Student'
	,@CodeValue29	NVARCHAR(50)	=	'NMPREK'
	,@StringVal29B	NVARCHAR(100)	=	'NMPREK-FD3Y'
	,@StringVal30A	NVARCHAR(100)	=	'NMPREK 4 Year Old Full-Day Student'
	,@CodeValue30	NVARCHAR(50)	=	'NMPREK'
	,@StringVal30B	NVARCHAR(100)	=	'NMPREK-FD4Y'
	-- Added new variable names since this expanded from two entries to six!
	,@StringVal50A	NVARCHAR(100)	=	'NMPREK Mixed Age Full-Day Student'
	,@CodeValue50	NVARCHAR(50)	=	'NMPREK'
	,@StringVal50B	NVARCHAR(100)	=	'NMPREK-FDMY'
	,@StringVal51A	NVARCHAR(100)	=	'NMPREK 3 Year Old Extended Full-Day Student'
	,@CodeValue51	NVARCHAR(50)	=	'NMPREK'
	,@StringVal51B	NVARCHAR(100)	=	'NMPREK-EFD3Y'
	,@StringVal52A	NVARCHAR(100)	=	'NMPREK 4 Year Old Extended Full-Day Student'
	,@CodeValue52	NVARCHAR(50)	=	'NMPREK'
	,@StringVal52B	NVARCHAR(100)	=	'NMPREK-EFD4Y'
	,@StringVal53A	NVARCHAR(100)	=	'NMPREK Mixed Age Extended Full-Day Student'
	,@CodeValue53	NVARCHAR(50)	=	'NMPREK'
	,@StringVal53B	NVARCHAR(100)	=	'NMPREK-EFDMY'
	,@StringVal54A	NVARCHAR(100)	=	'NM PreK program - Participation Code 450HR'
	,@CodeValue54	NVARCHAR(50)	=	'NMPREK'
	,@StringVal54B	NVARCHAR(100)	=	'NMPREK-450HR'
...
BEGIN
	...
	SET @DynSQL = 
		'INSERT INTO [edfi].[Program]( 
			...
			(' + CAST(@EdOrgId AS NVARCHAR(10))  + ' 
			, ''' + @StringVal50A  + ''' 
			, (' + @DynSQL_Sel + ' AND [Namespace] = ''' + @CodeType1 + ''' AND [CodeValue] = ''' + @CodeValue50 + ''')			
			, ''' + @StringVal50B  + ''' 
			, GETDATE(), GETDATE()
		),
			(' + CAST(@EdOrgId AS NVARCHAR(10))  + ' 
			, ''' + @StringVal51A  + ''' 
			, (' + @DynSQL_Sel + ' AND [Namespace] = ''' + @CodeType1 + ''' AND [CodeValue] = ''' + @CodeValue51 + ''')			
			, ''' + @StringVal51B  + ''' 
			, GETDATE(), GETDATE()
		),
			(' + CAST(@EdOrgId AS NVARCHAR(10))  + ' 
			, ''' + @StringVal52A  + ''' 
			, (' + @DynSQL_Sel + ' AND [Namespace] = ''' + @CodeType1 + ''' AND [CodeValue] = ''' + @CodeValue52 + ''')			
			, ''' + @StringVal52B  + ''' 
			, GETDATE(), GETDATE()
		),
			(' + CAST(@EdOrgId AS NVARCHAR(10))  + ' 
			, ''' + @StringVal53A  + ''' 
			, (' + @DynSQL_Sel + ' AND [Namespace] = ''' + @CodeType1 + ''' AND [CodeValue] = ''' + @CodeValue53 + ''')			
			, ''' + @StringVal53B  + ''' 
			, GETDATE(), GETDATE()
		),
			(' + CAST(@EdOrgId AS NVARCHAR(10))  + ' 
			, ''' + @StringVal54A  + ''' 
			, (' + @DynSQL_Sel + ' AND [Namespace] = ''' + @CodeType1 + ''' AND [CodeValue] = ''' + @CodeValue54 + ''')			
			, ''' + @StringVal54B  + ''' 
			, GETDATE(), GETDATE()
		);'
