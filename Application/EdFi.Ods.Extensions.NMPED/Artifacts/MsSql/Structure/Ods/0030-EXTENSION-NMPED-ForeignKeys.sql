...
ALTER TABLE [nmped].[BEPProgramLanguageDescriptor] WITH CHECK ADD CONSTRAINT [FK_BEPProgramLanguageDescriptor_Descriptor] FOREIGN KEY ([BEPProgramLanguageDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO

ALTER TABLE [nmped].[DataCollectionPeriodDescriptor] WITH CHECK ADD CONSTRAINT [FK_DataCollectionPeriodDescriptor_Descriptor] FOREIGN KEY ([DataCollectionPeriodDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [nmped].[FosterCustodialAuthorityDescriptor] WITH CHECK ADD CONSTRAINT [FK_FosterCustodialAuthorityDescriptor_Descriptor] FOREIGN KEY ([FosterCustodialAuthorityDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [nmped].[MedAlertDescriptor] WITH CHECK ADD CONSTRAINT [FK_MedAlertDescriptor_Descriptor] FOREIGN KEY ([MedAlertDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO

ALTER TABLE [nmped].[MEPProjectTypeDescriptor] WITH CHECK ADD CONSTRAINT [FK_MEPProjectTypeDescriptor_Descriptor] FOREIGN KEY ([MEPProjectTypeDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [nmped].[RestraintEventExtension] WITH CHECK ADD CONSTRAINT [FK_RestraintEventExtension_RestraintEvent] FOREIGN KEY ([RestraintEventIdentifier], [SchoolId], [StudentUSI])
REFERENCES [edfi].[RestraintEvent] ([RestraintEventIdentifier], [SchoolId], [StudentUSI])
ON DELETE CASCADE
GO

ALTER TABLE [nmped].[RestraintEventExtension] WITH CHECK ADD CONSTRAINT [FK_RestraintEventExtension_RestraintTypeDescriptor] FOREIGN KEY ([RestraintTypeDescriptorId])
REFERENCES [nmped].[RestraintTypeDescriptor] ([RestraintTypeDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_RestraintEventExtension_RestraintTypeDescriptor]
ON [nmped].[RestraintEventExtension] ([RestraintTypeDescriptorId] ASC)
GO

ALTER TABLE [nmped].[RestraintTypeDescriptor] WITH CHECK ADD CONSTRAINT [FK_RestraintTypeDescriptor_Descriptor] FOREIGN KEY ([RestraintTypeDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [nmped].[StaffEducationOrganizationVacancy] WITH CHECK ADD CONSTRAINT [FK_StaffEducationOrganizationVacancy_DataCollectionPeriodDescriptor] FOREIGN KEY ([DataCollectionPeriodDescriptorId])
REFERENCES [nmped].[DataCollectionPeriodDescriptor] ([DataCollectionPeriodDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StaffEducationOrganizationVacancy_DataCollectionPeriodDescriptor]
ON [nmped].[StaffEducationOrganizationVacancy] ([DataCollectionPeriodDescriptorId] ASC)
GO

ALTER TABLE [nmped].[StaffEducationOrganizationVacancy] WITH CHECK ADD CONSTRAINT [FK_StaffEducationOrganizationVacancy_LocalEducationAgency] FOREIGN KEY ([LocalEducationAgencyId])
REFERENCES [edfi].[LocalEducationAgency] ([LocalEducationAgencyId])
GO

CREATE NONCLUSTERED INDEX [FK_StaffEducationOrganizationVacancy_LocalEducationAgency]
ON [nmped].[StaffEducationOrganizationVacancy] ([LocalEducationAgencyId] ASC)
GO

ALTER TABLE [nmped].[StaffEducationOrganizationVacancy] WITH CHECK ADD CONSTRAINT [FK_StaffEducationOrganizationVacancy_SchoolYearType] FOREIGN KEY ([SchoolYear])
REFERENCES [edfi].[SchoolYearType] ([SchoolYear])
GO

CREATE NONCLUSTERED INDEX [FK_StaffEducationOrganizationVacancy_SchoolYearType]
ON [nmped].[StaffEducationOrganizationVacancy] ([SchoolYear] ASC)
GO

ALTER TABLE [nmped].[StaffEducationOrganizationVacancy] WITH CHECK ADD CONSTRAINT [FK_StaffEducationOrganizationVacancy_VacancyGroupDescriptor] FOREIGN KEY ([VacancyGroupDescriptorId])
REFERENCES [nmped].[VacancyGroupDescriptor] ([VacancyGroupDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StaffEducationOrganizationVacancy_VacancyGroupDescriptor]
...
ALTER TABLE [nmped].[StudentEducationOrganizationAssociationStudentCharacteristicExtension] WITH CHECK ADD CONSTRAINT [FK_StudentEducationOrganizationAssociationStudentCharacteristicExtension_FosterCustodialAuthorityDescriptor] FOREIGN KEY ([FosterCustodialAuthorityDescriptorId])
REFERENCES [nmped].[FosterCustodialAuthorityDescriptor] ([FosterCustodialAuthorityDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StudentEducationOrganizationAssociationStudentCharacteristicExtension_FosterCustodialAuthorityDescriptor]
ON [nmped].[StudentEducationOrganizationAssociationStudentCharacteristicExtension] ([FosterCustodialAuthorityDescriptorId] ASC)
GO
...
ALTER TABLE [nmped].[StudentEducationOrganizationAssociationStudentCharacteristicExtension] WITH CHECK ADD CONSTRAINT [FK_StudentEducationOrganizationAssociationStudentCharacteristicExtension_Staff] FOREIGN KEY ([GiftedStaffUSI])
REFERENCES [edfi].[Staff] ([StaffUSI])
GO

CREATE NONCLUSTERED INDEX [FK_StudentEducationOrganizationAssociationStudentCharacteristicExtension_Staff]
ON [nmped].[StudentEducationOrganizationAssociationStudentCharacteristicExtension] ([GiftedStaffUSI] ASC)
GO
...
ALTER TABLE [nmped].[StudentMigrantEducationProgramAssociationExtension] WITH CHECK ADD CONSTRAINT [FK_StudentMigrantEducationProgramAssociationExtension_MedAlertDescriptor] FOREIGN KEY ([MedAlertDescriptorId])
REFERENCES [nmped].[MedAlertDescriptor] ([MedAlertDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StudentMigrantEducationProgramAssociationExtension_MedAlertDescriptor]
ON [nmped].[StudentMigrantEducationProgramAssociationExtension] ([MedAlertDescriptorId] ASC)
GO

ALTER TABLE [nmped].[StudentMigrantEducationProgramAssociationExtension] WITH CHECK ADD CONSTRAINT [FK_StudentMigrantEducationProgramAssociationExtension_MEPProjectTypeDescriptor] FOREIGN KEY ([MEPProjectTypeDescriptorId])
REFERENCES [nmped].[MEPProjectTypeDescriptor] ([MEPProjectTypeDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StudentMigrantEducationProgramAssociationExtension_MEPProjectTypeDescriptor]
ON [nmped].[StudentMigrantEducationProgramAssociationExtension] ([MEPProjectTypeDescriptorId] ASC)
GO

ALTER TABLE [nmped].[StudentMigrantEducationProgramAssociationExtension] WITH CHECK ADD CONSTRAINT [FK_StudentMigrantEducationProgramAssociationExtension_PersonalInformationVerificationDescriptor] FOREIGN KEY ([PersonalInformationVerificationDescriptorId])
REFERENCES [edfi].[PersonalInformationVerificationDescriptor] ([PersonalInformationVerificationDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StudentMigrantEducationProgramAssociationExtension_PersonalInformationVerificationDescriptor]
ON [nmped].[StudentMigrantEducationProgramAssociationExtension] ([PersonalInformationVerificationDescriptorId] ASC)
GO

ALTER TABLE [nmped].[StudentMigrantEducationProgramAssociationExtension] WITH CHECK ADD CONSTRAINT [FK_StudentMigrantEducationProgramAssociationExtension_StudentMigrantEducationProgramAssociation] FOREIGN KEY ([BeginDate], [EducationOrganizationId], [ProgramEducationOrganizationId], [ProgramName], [ProgramTypeDescriptorId], [StudentUSI])
...
ALTER TABLE [nmped].[StudentProgramAssociationExtension] WITH CHECK ADD CONSTRAINT [FK_StudentProgramAssociationExtension_BEPProgramLanguageDescriptor] FOREIGN KEY ([BEPProgramLanguageDescriptorId])
REFERENCES [nmped].[BEPProgramLanguageDescriptor] ([BEPProgramLanguageDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StudentProgramAssociationExtension_BEPProgramLanguageDescriptor]
...
ALTER TABLE [nmped].[StudentSchoolAssociationExtension] WITH CHECK ADD CONSTRAINT [FK_StudentSchoolAssociationExtension_StudentSchoolAssociation] FOREIGN KEY ([EntryDate], [SchoolId], [StudentUSI])
...
ALTER TABLE [nmped].[StudentSpecialEducationProgramAssociationIEPDates] WITH CHECK ADD CONSTRAINT [FK_StudentSpecialEducationProgramAssociationIEPDates_StudentSpecialEducationProgramAssociation] FOREIGN KEY ([BeginDate], [EducationOrganizationId], [ProgramEducationOrganizationId], [ProgramName], [ProgramTypeDescriptorId], [StudentUSI])
REFERENCES [edfi].[StudentSpecialEducationProgramAssociation] ([BeginDate], [EducationOrganizationId], [ProgramEducationOrganizationId], [ProgramName], [ProgramTypeDescriptorId], [StudentUSI])
GO

CREATE NONCLUSTERED INDEX [FK_StudentSpecialEducationProgramAssociationIEPDates_StudentSpecialEducationProgramAssociation]
ON [nmped].[StudentSpecialEducationProgramAssociationIEPDates] ([BeginDate] ASC, [EducationOrganizationId] ASC, [ProgramEducationOrganizationId] ASC, [ProgramName] ASC, [ProgramTypeDescriptorId] ASC, [StudentUSI] ASC)
GO
...
ALTER TABLE [nmped].[VacancyGroupDescriptor] WITH CHECK ADD CONSTRAINT [FK_VacancyGroupDescriptor_Descriptor] FOREIGN KEY ([VacancyGroupDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO
