...
BEGIN TRANSACTION
    IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'nmped.StudentSpecialEducationProgramAssociationIEPDates') AND name = N'UX_StudentSpecialEducationProgramAssociationIEPDates_ChangeVersion')
    CREATE INDEX [UX_StudentSpecialEducationProgramAssociationIEPDates_ChangeVersion] ON [nmped].[StudentSpecialEducationProgramAssociationIEPDates] ([ChangeVersion] ASC)
    GO
COMMIT
