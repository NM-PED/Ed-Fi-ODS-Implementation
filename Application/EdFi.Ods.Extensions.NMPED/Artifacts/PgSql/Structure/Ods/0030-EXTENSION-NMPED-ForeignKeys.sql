...
ALTER TABLE nmped.BEPProgramLanguageDescriptor ADD CONSTRAINT FK_ff2208_Descriptor FOREIGN KEY (BEPProgramLanguageDescriptorId)
REFERENCES edfi.Descriptor (DescriptorId)
ON DELETE CASCADE
;
...
ALTER TABLE nmped.FosterCustodialAuthorityDescriptor ADD CONSTRAINT FK_d2a94a_Descriptor FOREIGN KEY (FosterCustodialAuthorityDescriptorId)
REFERENCES edfi.Descriptor (DescriptorId)
ON DELETE CASCADE
;
...
ALTER TABLE nmped.MedAlertDescriptor ADD CONSTRAINT FK_6bcb7d_Descriptor FOREIGN KEY (MedAlertDescriptorId)
REFERENCES edfi.Descriptor (DescriptorId)
ON DELETE CASCADE
;
...
ALTER TABLE nmped.RestraintEventExtension ADD CONSTRAINT FK_cb239e_RestraintEvent FOREIGN KEY (RestraintEventIdentifier, SchoolId, StudentUSI)
REFERENCES edfi.RestraintEvent (RestraintEventIdentifier, SchoolId, StudentUSI)
ON DELETE CASCADE
;

ALTER TABLE nmped.RestraintEventExtension ADD CONSTRAINT FK_cb239e_RestraintTypeDescriptor FOREIGN KEY (RestraintTypeDescriptorId)
REFERENCES nmped.RestraintTypeDescriptor (RestraintTypeDescriptorId)
;

CREATE INDEX FK_cb239e_RestraintTypeDescriptor
ON nmped.RestraintEventExtension (RestraintTypeDescriptorId ASC);

ALTER TABLE nmped.RestraintTypeDescriptor ADD CONSTRAINT FK_b3c1cb_Descriptor FOREIGN KEY (RestraintTypeDescriptorId)
REFERENCES edfi.Descriptor (DescriptorId)
ON DELETE CASCADE
;
...
ALTER TABLE nmped.StudentEducationOrganizationAssociationStudentCharacteri_fc9b44 ADD CONSTRAINT FK_fc9b44_FosterCustodialAuthorityDescriptor FOREIGN KEY (FosterCustodialAuthorityDescriptorId)
REFERENCES nmped.FosterCustodialAuthorityDescriptor (FosterCustodialAuthorityDescriptorId)
;

CREATE INDEX FK_fc9b44_FosterCustodialAuthorityDescriptor
ON nmped.StudentEducationOrganizationAssociationStudentCharacteri_fc9b44 (FosterCustodialAuthorityDescriptorId ASC);
...
ALTER TABLE nmped.StudentEducationOrganizationAssociationStudentCharacteri_fc9b44 ADD CONSTRAINT FK_fc9b44_Staff FOREIGN KEY (GiftedStaffUSI)
REFERENCES edfi.Staff (StaffUSI)
;

CREATE INDEX FK_fc9b44_Staff
ON nmped.StudentEducationOrganizationAssociationStudentCharacteri_fc9b44 (GiftedStaffUSI ASC);
...
ALTER TABLE nmped.StudentMigrantEducationProgramAssociationExtension ADD CONSTRAINT FK_5cb254_MedAlertDescriptor FOREIGN KEY (MedAlertDescriptorId)
REFERENCES nmped.MedAlertDescriptor (MedAlertDescriptorId)
;

CREATE INDEX FK_5cb254_MedAlertDescriptor
...
ALTER TABLE nmped.StudentProgramAssociationExtension ADD CONSTRAINT FK_0c120d_BEPProgramLanguageDescriptor FOREIGN KEY (BEPProgramLanguageDescriptorId)
REFERENCES nmped.BEPProgramLanguageDescriptor (BEPProgramLanguageDescriptorId)
;

CREATE INDEX FK_0c120d_BEPProgramLanguageDescriptor
...
ALTER TABLE nmped.StudentSpecialEducationAssociationEvent ADD CONSTRAINT FK_1d3500_SpecialEducationEventReasonDescriptor FOREIGN KEY (SpecialEducationEventReasonDescriptorId)
...
ALTER TABLE nmped.StudentSpecialEducationAssociationEvent ADD CONSTRAINT FK_1d3500_SpecialEducationEventTypeDescriptor FOREIGN KEY (SpecialEducationEventTypeDescriptorId)
...
ALTER TABLE nmped.StudentSpecialEducationAssociationEvent ADD CONSTRAINT FK_1d3500_SpecialEducationNonComplianceReasonDescriptor FOREIGN KEY (SpecialEducationNonComplianceReasonDescriptorId)
REFERENCES nmped.SpecialEducationNonComplianceReasonDescriptor (SpecialEducationNonComplianceReasonDescriptorId)
;

CREATE INDEX FK_1d3500_SpecialEducationNonComplianceReasonDescriptor
ON nmped.StudentSpecialEducationAssociationEvent (SpecialEducationNonComplianceReasonDescriptorId ASC);

ALTER TABLE nmped.StudentSpecialEducationAssociationEvent ADD CONSTRAINT FK_1d3500_StudentSpecialEducationProgramAssociation FOREIGN KEY (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
...
CREATE INDEX FK_1d3500_StudentSpecialEducationProgramAssociation
...
ALTER TABLE nmped.StudentSpecialEducationProgramAssociationExtension ADD CONSTRAINT FK_3da84f_EducationOrganization FOREIGN KEY (ChildCountEducationOrganizationId)
REFERENCES edfi.EducationOrganization (EducationOrganizationId)
;

CREATE INDEX FK_3da84f_EducationOrganization
...
ALTER TABLE nmped.StudentSpecialEducationProgramAssociationIEPDates ADD CONSTRAINT FK_1dbb21_StudentSpecialEducationProgramAssociation FOREIGN KEY (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
REFERENCES edfi.StudentSpecialEducationProgramAssociation (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
;

CREATE INDEX FK_1dbb21_StudentSpecialEducationProgramAssociation
