...
CREATE TABLE nmped.BEPProgramLanguageDescriptor (
    ...
    CONSTRAINT BEPProgramLanguageDescriptor_PK PRIMARY KEY (BEPProgramLanguageDescriptorId)
);
...
CREATE TABLE nmped.DataCollectionPeriodDescriptor (
    ...
    CONSTRAINT DataCollectionPeriodDescriptor_PK PRIMARY KEY (DataCollectionPeriodDescriptorId)
);
...
CREATE TABLE nmped.FosterCustodialAuthorityDescriptor (
    ...
    CONSTRAINT FosterCustodialAuthorityDescriptor_PK PRIMARY KEY (FosterCustodialAuthorityDescriptorId)
);
...
CREATE TABLE nmped.MedAlertDescriptor (
    ...
    CONSTRAINT MedAlertDescriptor_PK PRIMARY KEY (MedAlertDescriptorId)
);

-- Table nmped.MEPProjectTypeDescriptor --
CREATE TABLE nmped.MEPProjectTypeDescriptor (
    MEPProjectTypeDescriptorId INT NOT NULL,
    CONSTRAINT MEPProjectTypeDescriptor_PK PRIMARY KEY (MEPProjectTypeDescriptorId)
);
...
ALTER TABLE nmped.RestraintEventExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp;

-- Table nmped.RestraintTypeDescriptor --
CREATE TABLE nmped.RestraintTypeDescriptor (
    RestraintTypeDescriptorId INT NOT NULL,
    CONSTRAINT RestraintTypeDescriptor_PK PRIMARY KEY (RestraintTypeDescriptorId)
);
...
CREATE TABLE nmped.StaffEducationOrganizationVacancy (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT StaffEducationOrganizationVacancy_PK PRIMARY KEY (DataCollectionPeriodDescriptorId, LocalEducationAgencyId, SchoolYear, VacancyGroupDescriptorId)
);
ALTER TABLE nmped.StaffEducationOrganizationVacancy ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
ALTER TABLE nmped.StaffEducationOrganizationVacancy ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE nmped.StaffEducationOrganizationVacancy ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp;
...
CREATE TABLE nmped.StudentMigrantEducationProgramAssociationExtension (
    ...
    ProgramTypeDescriptorId INT NOT NULL,
    StudentUSI INT NOT NULL,
    MSIXIdentificationNumber VARCHAR(20) NULL,
    PersonalInformationVerificationDescriptorId INT NULL,
    QualifyingMoveFromCity VARCHAR(300) NULL,
    QualifyingMoveFromState VARCHAR(300) NOT NULL,
    QualifyingMoveFromCountry VARCHAR(300) NOT NULL,
    QualifyingMoveToCity VARCHAR(300) NULL,
    QualifyingMoveToState VARCHAR(300) NULL,
    ImmunizationRecordFlag BOOLEAN NULL,
    MEPProjectTypeDescriptorId INT NULL,
    MedAlertDescriptorId INT NULL,
    EnrollmentComment VARCHAR(1000) NULL,
    OutOfStateTranscriptIndicator BOOLEAN NULL,
    ResidencyVerificationDate DATE NULL,
    Algebra1OrEquivalentIndicator BOOLEAN NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentMigrantEducationProgramAssociationExtension_PK PRIMARY KEY (BeginDate, EducationOrganizationId, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
);
ALTER TABLE nmped.StudentMigrantEducationProgramAssociationExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
CREATE TABLE nmped.StudentSchoolAssociationExtension (
    ...
    SchoolId INT NOT NULL,
    StudentUSI INT NOT NULL,
    GraduationIndicator BOOLEAN NOT NULL,
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT StudentSchoolAssociationExtension_PK PRIMARY KEY (EntryDate, SchoolId, StudentUSI)
);
ALTER TABLE nmped.StudentSchoolAssociationExtension ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
...
CREATE TABLE nmped.StudentSpecialEducationProgramAssociationIEPDates (
    ...
    LastModifiedDate TIMESTAMP NOT NULL,
    Id UUID NOT NULL,
    CONSTRAINT StudentSpecialEducationProgramAssociationIEPDates_PK PRIMARY KEY (BeginDate, EducationOrganizationId, IEPBeginDate, ProgramEducationOrganizationId, ProgramName, ProgramTypeDescriptorId, StudentUSI)
);
ALTER TABLE nmped.StudentSpecialEducationProgramAssociationIEPDates ALTER COLUMN CreateDate SET DEFAULT current_timestamp;
ALTER TABLE nmped.StudentSpecialEducationProgramAssociationIEPDates ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE nmped.StudentSpecialEducationProgramAssociationIEPDates ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp;
...
CREATE TABLE nmped.VacancyGroupDescriptor (
    VacancyGroupDescriptorId INT NOT NULL,
    CONSTRAINT VacancyGroupDescriptor_PK PRIMARY KEY (VacancyGroupDescriptorId)
);
